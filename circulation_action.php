...
if (isset($_POST['quickReturnID']) AND $_POST['quickReturnID']) {
    ...
    if ($loan_info_q->num_rows < 1) {
        echo '<div style="color: white; font-weight: bold;" class="errorBox">'.__('BUKU/EKSEMPLAR INI SUDAH DIKEMBALIKAN atau TIDAK TERDAFTAR PADA DATABASE PEMINJAMAN. Terima Kasih.').'</div>';
    } else {
